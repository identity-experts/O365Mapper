...
var checkboxText = "Run [ProductName]";      // Text for the checkbox on the finished dialog
var filename = "365Drive.Office365.NotificationManager.exe";       // The name of the executable to launch - change this to match the file you want to launch at the end of your setup
